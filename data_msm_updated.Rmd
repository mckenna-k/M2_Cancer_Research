...
mstate_simple <- function(name){
  df_new[["covar"]] <- df_new[[name]]
...
df_result <- rbind(df_result,mstate_simple("stage"))
...
df_result <- rbind(df_result,mstate_simple("var_nulle"))
...
df_result <- rbind(df_result,mstate_simple("T01"))
...
df_result <- rbind(df_result,mstate_simple("T02"))
